...
const Heading = ({ h2sub, h1main, paragraph, bgColor }) => {
    return (
        <div className={`flex flex-col items-center gap-1 pb-8 pt-12 px-5 text-center cursor-default ${bgColor}`}>
...
export const HeadingOpportunities = () => {
    const { language } = useLang();
    const t = HeadingHome.opportunities[language] || {};
    return <Heading h2sub={t.sub} h1main={t.main} />;
}
