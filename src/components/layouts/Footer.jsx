...
import { Location, Mail, Phone, Facebook, TikTok, Instagram } from './Icons';
                ...
                <div className="flex justify-center">
                    <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-[2fr_3fr_2fr] w-full max-w-[1440px]">
                        ...
                        <div className="flex flex-col justify-center items-center md:items-start w-full text-sm h-full px-16">
                            ...
                            >
                                <Location className="w-3 h-3 shrink-0 mt-1" />
                        ...
                        <div className="flex flex-col justify-center px-5 py-4">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div className="flex flex-col align-top text-sm py-4">
                                    ...
                                    <a href="/" className="py-1 font-regular text-[#5C6370] hover:text-[#0A142F] hover:font-medium transition-all">{t.nav.home}</a>
                                    <a href="/about" className="py-1 font-regular text-[#5C6370] hover:text-[#0A142F] hover:font-medium transition-all">{t.nav.about}</a>
                                    <a href="/services" className="py-1 font-regular text-[#5C6370] hover:text-[#0A142F] hover:font-medium transition-all">{t.nav.services}</a>
                                    <a href="/news" className="py-1 font-regular text-[#5C6370] hover:text-[#0A142F] hover:font-medium transition-all">{t.nav.blog}</a>
                                </div>
